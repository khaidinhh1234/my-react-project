...
const LoaiSanpham = ({loaisps , Xoalsp  } ) => {
  return (
    <div>
      <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 className="h2">Danh Sách Thể Loại </h1>
        <div className="btn-toolbar mb-2 mb-md-0">
          <Link to="/admin/loaisps/add" type="button" className="btn btn-primary   tw-mr-20">
            <svg className="bi">
        ...
        <table className="table table-striped table-sm tw-text-center">
          ...
          <tbody>
            ...
            <tr key = {i}>
              ...
              <td>
                <button className="btn btn-danger " onClick={()=>Xoalsp(lsp.id)}>Xóa</button>
                <Link
